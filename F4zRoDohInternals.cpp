...
namespace interfaces
{
	...
	F4SEMessagingInterface*		kMsgInterface = nullptr;
}

F4zRoDohINIManager		F4zRoDohINIManager::Instance;
...
void F4zRoDohINIManager::Initialize(const char* INIPath, void* Paramenter)
{
...
BSIStream* BSIStream::CreateInstance(const char* FilePath, void* ParentLocation, bool Arg3)
{
	...
	return CALL_MEMBER_FN(Instance, Ctor)(FilePath, ParentLocation, Arg3);
}
